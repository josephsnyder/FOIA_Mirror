...
RG*1.0*49
"BLD",7367,0)
RG*1.0*49^CLINICAL INFO RESOURCE NETWORK^0^3070927^y
"BLD",7367,1,0)
^^1^1^3070920^
"BLD",7367,1,1,0)
...
RGADTP2^^0^B49150519
"BLD",7367,"KRN",9.8,"NM","B","RGADTP2",1)

"BLD",7367,"KRN",19,0)
19
"BLD",7367,"KRN",19,"NM",0)
^9.68A^1^1
"BLD",7367,"KRN",19,"NM",1,0)
RG ADMIN USER MENU^^0
"BLD",7367,"KRN",19,"NM","B","RG ADMIN USER MENU",1)
...
"BLD",7367,"REQB",2,0)
RG*1.0*48^1
"BLD",7367,"REQB","B","DG*5.3*766",1)

"BLD",7367,"REQB","B","RG*1.0*48",2)

"KRN",19,10235,-1)
0^1
"KRN",19,10235,0)
RG ADMIN USER MENU^MPI/PD Patient Admin User Menu^OBSOLETE WITH RG*1.0*49^M^^^^^^^^CLINICAL INFO RESOURCE NETWORK
"KRN",19,10235,1,0)
^19.06^3^3^3070919^^^^
"KRN",19,10235,1,1,0)
...
"RTN","RGADTP2",2,0)
 ;;1.0;CLINICAL INFO RESOURCE NETWORK;**27,20,45,44,47,48,49**;30 Apr 99;Build 1
"RTN","RGADTP2",3,0)
DBIA ;
"RTN","RGADTP2",4,0)
