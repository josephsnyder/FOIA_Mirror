...
ROR*1.5*7
"BLD",6966,0)
ROR*1.5*7^CLINICAL CASE REGISTRIES^0^3080424^y
"BLD",6966,1,0)
^^1^1^3080128^
"BLD",6966,1,1,0)
...
RORP007^^0^B70618
"BLD",6966,"KRN",9.8,"NM","B","RORP007",2)
...
"BLD",6966,"REQB",2,0)
PSN*4.0*166^1
"BLD",6966,"REQB","B","PSN*4.0*166",2)

"BLD",6966,"REQB","B","ROR*1.5*1",1)
...
37^ETRAVIRINE^VA HIV^99^4335^ETRAVIRINE^1
