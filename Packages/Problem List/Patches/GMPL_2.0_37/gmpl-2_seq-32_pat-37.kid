EMERGENCY Released GMPL*2*37 SEQ #32
...
GMPL*2.0*37
"BLD",18738,0)
GMPL*2.0*37^PROBLEM LIST^0^3081001^y
"BLD",18738,1,0)
^^1^1^3081001^
"BLD",18738,1,1,0)
...
"BLD",18738,"KRN",9.8,0)
9.8
"BLD",18738,"KRN",9.8,"NM",0)
^9.68A^2^2
"BLD",18738,"KRN",9.8,"NM",1,0)
GMPLP37I^^0^B8498002
"BLD",18738,"KRN",9.8,"NM",2,0)
GMPLSAVE^^0^B29343254
"BLD",18738,"KRN",9.8,"NM","B","GMPLP37I",1)

"BLD",18738,"KRN",9.8,"NM","B","GMPLSAVE",2)

"BLD",18738,"KRN",19,0)
19
"BLD",18738,"KRN",19.1,0)
19.1
"BLD",18738,"KRN",101,0)
101
"BLD",18738,"KRN",409.61,0)
409.61
"BLD",18738,"KRN",771,0)
771
"BLD",18738,"KRN",779.2,0)
779.2
"BLD",18738,"KRN",870,0)
870
"BLD",18738,"KRN",8989.51,0)
8989.51
"BLD",18738,"KRN",8989.52,0)
8989.52
"BLD",18738,"KRN",8994,0)
8994
"BLD",18738,"KRN","B",.4,.4)

"BLD",18738,"KRN","B",.401,.401)

"BLD",18738,"KRN","B",.402,.402)

"BLD",18738,"KRN","B",.403,.403)

"BLD",18738,"KRN","B",.5,.5)

"BLD",18738,"KRN","B",.84,.84)

"BLD",18738,"KRN","B",3.6,3.6)

"BLD",18738,"KRN","B",3.8,3.8)

"BLD",18738,"KRN","B",9.2,9.2)

"BLD",18738,"KRN","B",9.8,9.8)

"BLD",18738,"KRN","B",19,19)

"BLD",18738,"KRN","B",19.1,19.1)

"BLD",18738,"KRN","B",101,101)

"BLD",18738,"KRN","B",409.61,409.61)

"BLD",18738,"KRN","B",771,771)

"BLD",18738,"KRN","B",779.2,779.2)

"BLD",18738,"KRN","B",870,870)

"BLD",18738,"KRN","B",8989.51,8989.51)

"BLD",18738,"KRN","B",8989.52,8989.52)

"BLD",18738,"KRN","B",8994,8994)
...
"RTN","GMPLP37I",76,0)
 Q
"RTN","GMPLSAVE")
0^2^B29343254^B28058379
"RTN","GMPLSAVE",1,0)
GMPLSAVE ; SLC/MKB/KER -- Save Problem List data ; 10/01/2008
"RTN","GMPLSAVE",2,0)
 ;;2.0;Problem List;**26,31,35,37**;Aug 25, 1994;Build 1
"RTN","GMPLSAVE",3,0)
 ;
"RTN","GMPLSAVE",4,0)
 ; External References
...
"RTN","GMPLSAVE",12,0)
 I $G(GMPFLD(1.14))[U S GMPFLD(1.14)=""
"RTN","GMPLSAVE",13,0)
