...
PSS*1.0*126
"BLD",6347,0)
PSS*1.0*126^PHARMACY DATA MANAGEMENT^0^3070821^y
"BLD",6347,1,0)
^^2^2^3070501^
"BLD",6347,1,1,0)
...
"BLD",6347,4,50,2,0)
^9.641^50^1
"BLD",6347,4,50,2,50,0)
DRUG  (File-top level)
"BLD",6347,4,50,2,50,1,0)
^9.6411^3^1
"BLD",6347,4,50,2,50,1,3,0)
DEA, SPECIAL HDLG
"BLD",6347,4,50,222)
y^n^p^^^^n^^n
"BLD",6347,4,50,224)

"BLD",6347,4,"APDD",50,50)

"BLD",6347,4,"APDD",50,50,3)
...
PSSDDUT2^^0^B81292420
"BLD",6347,"KRN",9.8,"NM","B","PSSDDUT2",1)
...
"RTN","PSS1P126",26,0)
 Q
"RTN","PSSDDUT2")
0^1^B81292420^B68142522
"RTN","PSSDDUT2",1,0)
PSSDDUT2 ;BIR/LDT - Pharmacy Data Management DD Utility ; 8/21/07 8:43am
"RTN","PSSDDUT2",2,0)
 ;;1.0; PHARMACY DATA MANAGEMENT; **3,21,61,81,95,127,126**;9/30/97;Build 11
"RTN","PSSDDUT2",3,0)
 ;
"RTN","PSSDDUT2",4,0)
...
"^DD",50,50,3,4)
D:X="?" DEA^PSSDDUT2 D:X?2."?" DEATBL^PSSDDUT2
"^DD",50,50,3,20,0)
^.3LA^1^1
"^DD",50,50,3,20,1,0)
PH
